...
from util.wordwrap import wordWrap
...
class HoveringState(StringRenderer):
    ...
    def draw(self,surface):
        ...
        for i,(k,v) in enumerate(self.slot.item.attributes.items()):
            posEffect = v > 0
            self.drawString(panel, "{} {} {}".format("+" if posEffect else "-", abs(v), k), (8, 32 + i * 16), color = pg.Color('green') if posEffect else pg.Color('red'))
